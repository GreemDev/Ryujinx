...
namespace Ryujinx.Graphics.Nvdec.Vp9
{
    internal static class Luts
    {
        ...
        public static readonly BlockSize[][][] SsSizeLookup = [
            ...
            [[BlockSize.Block4x4, BlockSize.BlockInvalid], [BlockSize.BlockInvalid, BlockSize.BlockInvalid]],
            [[BlockSize.Block4x8, BlockSize.Block4x4], [BlockSize.BlockInvalid, BlockSize.BlockInvalid]],
            [[BlockSize.Block8x4, BlockSize.BlockInvalid], [BlockSize.Block4x4, BlockSize.BlockInvalid]],
            [[BlockSize.Block8x8, BlockSize.Block8x4], [BlockSize.Block4x8, BlockSize.Block4x4]],
            [[BlockSize.Block8x16, BlockSize.Block8x8], [BlockSize.BlockInvalid, BlockSize.Block4x8]],
            [[BlockSize.Block16x8, BlockSize.BlockInvalid], [BlockSize.Block8x8, BlockSize.Block8x4]],
            [[BlockSize.Block16x16, BlockSize.Block16x8], [BlockSize.Block8x16, BlockSize.Block8x8]],
            [[BlockSize.Block16x32, BlockSize.Block16x16], [BlockSize.BlockInvalid, BlockSize.Block8x16]],
            [[BlockSize.Block32x16, BlockSize.BlockInvalid], [BlockSize.Block16x16, BlockSize.Block16x8]],
            [[BlockSize.Block32x32, BlockSize.Block32x16], [BlockSize.Block16x32, BlockSize.Block16x16]],
            [[BlockSize.Block32x64, BlockSize.Block32x32], [BlockSize.BlockInvalid, BlockSize.Block16x32]],
            [[BlockSize.Block64x32, BlockSize.BlockInvalid], [BlockSize.Block32x32, BlockSize.Block32x16]],
            [[BlockSize.Block64x64, BlockSize.Block64x32], [BlockSize.Block32x64, BlockSize.Block32x32]],
        ];
        ...
        public static readonly TxSize[][][][] UvTxsizeLookup = [
          ...
          [
              // BLOCK_4X4
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
          ],
          ...
          [
              // BLOCK_8X8
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
          ],
          [
              // BLOCK_8X16
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx4x4, TxSize.Tx4x4]],
          ],
          [
              // BLOCK_16X8
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx4x4], [TxSize.Tx8x8, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx4x4], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx8x8, TxSize.Tx4x4], [TxSize.Tx8x8, TxSize.Tx8x8]],
          ],
          [
              // BLOCK_16X16
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
          ],
          [
              // BLOCK_16X32
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx16x16], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx16x16], [TxSize.Tx8x8, TxSize.Tx8x8]],
          ],
          [
              // BLOCK_32X16
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx8x8], [TxSize.Tx16x16, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx8x8], [TxSize.Tx16x16, TxSize.Tx8x8]],
          ],
          [
              // BLOCK_32X32
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx16x16], [TxSize.Tx16x16, TxSize.Tx16x16]],
              [[TxSize.Tx32x32, TxSize.Tx16x16], [TxSize.Tx16x16, TxSize.Tx16x16]],
          ],
          [
              // BLOCK_32X64
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx16x16], [TxSize.Tx16x16, TxSize.Tx16x16]],
              [[TxSize.Tx32x32, TxSize.Tx32x32], [TxSize.Tx16x16, TxSize.Tx16x16]],
          ],
          [
              // BLOCK_64X32
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx16x16], [TxSize.Tx16x16, TxSize.Tx16x16]],
              [[TxSize.Tx32x32, TxSize.Tx16x16], [TxSize.Tx32x32, TxSize.Tx16x16]],
          ],
          [
              // BLOCK_64X64
              [[TxSize.Tx4x4, TxSize.Tx4x4], [TxSize.Tx4x4, TxSize.Tx4x4]],
              [[TxSize.Tx8x8, TxSize.Tx8x8], [TxSize.Tx8x8, TxSize.Tx8x8]],
              [[TxSize.Tx16x16, TxSize.Tx16x16], [TxSize.Tx16x16, TxSize.Tx16x16]],
              [[TxSize.Tx32x32, TxSize.Tx32x32], [TxSize.Tx32x32, TxSize.Tx32x32]],
          ],
        ];
        ...
        public static ReadOnlySpan<sbyte> Vp9MvFPTree => [-0, 2, -1, 4, -2, -3];

        // Entropy

        public static ReadOnlySpan<byte> Vp9Cat1Prob => [159];
        public static ReadOnlySpan<byte> Vp9Cat2Prob => [165, 145];
        public static ReadOnlySpan<byte> Vp9Cat3Prob => [173, 148, 140];
        public static ReadOnlySpan<byte> Vp9Cat4Prob => [176, 155, 140, 135];
        public static ReadOnlySpan<byte> Vp9Cat5Prob => [180, 157, 141, 134, 130];
        public static ReadOnlySpan<byte> Vp9Cat6Prob => [254, 254, 254, 252, 249, 243, 230, 196, 177, 153, 140, 133, 130, 129];

        public static ReadOnlySpan<byte> Vp9Cat6ProbHigh12 =>
        [
        ...
        private static ReadOnlySpan<byte> Vp9CoefbandTrans4X4 =>
        [
