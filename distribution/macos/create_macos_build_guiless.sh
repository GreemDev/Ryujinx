...
if [ "$VERSION" == "1.1.0" ];
then
  RELEASE_TAR_FILE_NAME=sdl2-ryujinx-guiless-$CONFIGURATION-$VERSION+$SOURCE_REVISION_ID-macos_universal.tar
else
  RELEASE_TAR_FILE_NAME=sdl2-ryujinx-guiless-$VERSION-macos_universal.tar
fi
